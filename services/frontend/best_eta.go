...
import (
	...
	"github.com/patil-kshitij/hotrod/pkg/pool"
	"github.com/patil-kshitij/hotrod/services/config"
	"github.com/patil-kshitij/hotrod/services/customer"
	"github.com/patil-kshitij/hotrod/services/driver"
	"github.com/patil-kshitij/hotrod/services/route"
...
func (eta *bestETA) getRoutes(ctx context.Context, customer *customer.Customer, drivers []driver.Driver) []routeResult {
	...
	_, span := otelTracer.Start(ctx, "getRoutes", trace.WithSpanKind(trace.SpanKindInternal))
	defer span.End()
